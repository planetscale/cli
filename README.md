...
You can install and use the program using `script/build` or `go install ./...`. After doing so, you can run the tool using `planet <command> [subcommand] [flags]`.
