...
func LintNextSteps(result *LintResult) []NextStep {
	steps := []NextStep{
		{
			...
			Command: "pscale import d1 start --input " + filepath.Base(result.InputPath) + " --database <database> --dry-run",
	...
	if result.ErrorCount == 0 {
		steps = append(steps, NextStep{
			Tool:    "import_d1_start",
			Command: "pscale import d1 start --input " + filepath.Base(result.InputPath) + " --database <database>",
